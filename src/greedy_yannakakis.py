...
def cut_partition_to_edge_partition(G: nx.DiGraph, cut_partition: ST_partition) -> set:
    edge_partition = set()
    for edge in G.edges():
        # print(edge)
        # print(cut_partition)
...
def varizani_yannakakis_directed(G: nx.DiGraph) -> list[Cut]:
    ...
    while not queue.empty():
        ...
        current_edge_partition = cut_partition_to_edge_partition(G, current_cut.st_partition)
        current_edge_vector = edge_partition_to_vector(G, current_edge_partition)
